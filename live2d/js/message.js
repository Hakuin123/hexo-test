...
this.location='http://www.heibbs.net/index.php';
}
...
console.log("略略略，就不加");
console.log("\n %c 罗小黑妖灵论坛 %c http://www.heibbs.net \n","color: #ACCBAA;background: #111111;padding:5px 0;","background:#BBBBBB;padding:5px 0;");
...
(function (){
    ...
    if(document.referrer !== ''){
        ...
        if (window.location.href == `jQuery{home_Path}`) { //主页URL判断，需要斜杠结尾
...
function showHitokoto(){
    jQuery.getJSON('https://v1.hitokoto.cn/',function(result){
        showMessage("票君 价格 100 天明珠", 5000);
    });
}
...
function initLive2d (){
    ...
    jQuery('#landlord').hover(() => {
        jQuery('.hide-button').fadeIn(600)
    }, () => {
        jQuery('.hide-button').fadeOut(600)
    })
}
initLive2d ();
